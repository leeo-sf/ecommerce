...
namespace Ecommerce.Data.Migrations
{
    ...
    [Migration("20250711233810_UpdatePromotionSchema")]
    partial class UpdatePromotionSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entity.Promotion", b =>
                {
                    ...
                    b.Property<Guid>("ProductId")
                        ...
                        .HasComment("Produto que pertence o desconto");

                    b.Property<DateTime?>("PromotionStartsIn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("promotion_starts_in")
                        .HasComment("Data e hora que a promoção inicia");
                    ...
                    b.Property<DateTime?>("ValidUntil")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("valid_until")
                        .HasComment("Data e hora que a promoção encerra");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entity.Promotion", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entity.Product", "Product")
                        .WithOne("Promotion")
                        .HasForeignKey("Ecommerce.Domain.Entity.Promotion", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
